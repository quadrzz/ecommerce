    ...
    <main>
      ...
      <section className="py-20 md:py-32">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <p className="text-muted-foreground font-body text-center mb-16 max-w-md mx-auto">
            Comparar opções e encontrar a ideal para sua parede
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            ...
            >
              <h3 className="text-lg font-display tracking-wider mb-2">ESSENCIAL</h3>
              <p className="text-xs text-muted-foreground font-body mb-6">Ideal para quem quer começar</p>
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-green-500">✓</span>
                  <span className="text-muted-foreground">Placa metálica premium</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-green-500">✓</span>
                  <span className="text-muted-foreground">Impressão em alta definição</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
              ...
              <div className="text-center mb-6">
                <p className="text-2xl font-display tracking-wider">A partir de</p>
                <p className="text-4xl font-bold">R$37,90</p>
                <p className="text-xs text-muted-foreground mt-2">Frete não incluso</p>
              </div>
            ...
            <motion.div
              ...
              className="bg-secondary p-8 metal-border"
            >
              <h3 className="text-lg font-display tracking-wider mb-2">PREMIUM</h3>
              <p className="text-xs text-muted-foreground font-body mb-6">Mais completo e sofisticado</p>
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-green-500">✓</span>
                  <span className="text-muted-foreground">Placa metálica premium</span>
                ...
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-green-500">✓</span>
                  <span className="text-muted-foreground">Moldura Eco inclusa</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-green-500">✓</span>
                  <span className="text-muted-foreground">Pronto para pendurar</span>
                </div>
              </div>
              <div className="text-center mb-6">
                <p className="text-2xl font-display tracking-wider">A partir de</p>
                <p className="text-4xl font-bold">R$47,90</p>
                <p className="text-xs text-muted-foreground mt-2">Frete não incluso</p>
              </div>
              <Button variant="outline" className="w-full">ESCOLHER</Button>
            </motion.div>

            {/* Combo Quadrzz - DESTAQUE */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ delay: 0.2 }}
              className="bg-gradient-from bg-secondary p-8 metal-border relative scale-105 shadow-[0_0_40px_rgba(255,165,0,0.3)]"
            >
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 flex gap-2">
                <span className="bg-orange-500 text-black text-[10px] font-bold px-3 py-1 tracking-wider">MAIS ESCOLHIDO</span>
                <span className="bg-green-500 text-black text-[10px] font-bold px-3 py-1 tracking-wider">BEST SELLER</span>
              </div>
              
              <h3 className="text-xl font-display tracking-wider mb-2 text-orange-400">COMBO QUADRZZ</h3>
              <p className="text-xs text-muted-foreground font-body mb-6">A escolha de quem leva identidade de verdade</p>
              
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-green-500">✓</span>
                  <span className="text-foreground font-medium">04 placas metálicas premium</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-green-500">✓</span>
                  <span className="text-foreground font-medium">Moldura Eco inclusa</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-green-500">✓</span>
                  <span className="text-foreground font-medium">Impressão HD ultra nítida</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-green-500">✓</span>
                  <span className="text-foreground font-medium">Bônus exclusivo Quadrzz</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-green-500">✓</span>
                  <span className="text-orange-400 font-bold">Frete grátis Brasil</span>
                </div>
              </div>
              
              <div className="text-center mb-6">
                <p className="text-lg text-muted-foreground font-body">Condição especial no combo</p>
                <p className="text-5xl font-bold text-orange-400">R$167,90</p>
                <p className="text-xs text-muted-foreground mt-2">De R$239,90 por R$167,90</p>
              </div>
              
              <Button variant="metal" size="xl" className="w-full bg-orange-500 hover:bg-orange-600 text-black font-display tracking-wider">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
            className="mt-16 text-center bg-secondary/50 p-8 metal-border max-w-2xl mx-auto"
          >
            <h3 className="text-xl font-display tracking-wider mb-4">CONDIÇÕES FACILITADAS</h3>
            <p className="text-muted-foreground font-body mb-6">
              Parcele em até 12x no cartão ou pague à vista no PIX com desconto exclusivo.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Button variant="metal" className="bg-orange-500 hover:bg-orange-600 text-black">
                🔥 QUERO MEU COMBO AGORA
              </Button>
              <Button variant="outline">
                🎯 ESCOLHER MEUS QUADROS
              </Button>
            </div>
          </motion.div>
        </div>
